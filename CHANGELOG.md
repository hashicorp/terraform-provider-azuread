...
* **New Resource**: `azuread_group_license` ([#1890](...))
* **New Resource**: `azuread_user_license` ([#1879](...))
* **New Resource**: `azuread_authentication_strength_policy_fido2_combination_configuration` ([#1881](...))
* **New Resource**: `azuread_authentication_strength_policy_x509_combination_configuration` ([#1881](...))
* **New Data Source**: `azuread_authentication_strength_policy` ([#1887](...))
* `azuread_authentication_strength_policy` - add `object_id` output attribute ([#1954](...))
* Data Source: `azuread_groups` - Add `groups` output attribute ([#1770](...))
* dependencies: update `go` to version `1.26.6` ([#1939](...))
* dependencies: update `golangci-lint` to version `v2.12.2` ([#1907](...))
* dependencies: update `github.com/hashicorp/go-azure-helpers` to version `v0.81.1` ([#1907](...))
* dependencies: update `github.com/hashicorp/hc-install` to version `v0.9.4` ([#1907](...))
* dependencies: update `github.com/hashicorp/terraform-exec` to version `v0.25.1` ([#1907](...))
* dependencies: update `github.com/hashicorp/terraform-plugin-sdk/v2` to version `v2.40.1` ([#1907](...))
* dependencies: update `github.com/hashicorp/terraform-plugin-testing` to version `v1.16.0` ([#1907](...))
* dependencies: update `golang.org/x/crypto` to version `v0.56.0` ([#1961](...))
* dependencies: update `golang.org/x/mod` to version `v0.40.0` ([#1961](...))
* dependencies: update `golang.org/x/net` to version `v0.57.0` ([#1907](...))
* dependencies: update `golang.org/x/oauth2` to version `v0.36.0` ([#1907](...))
* dependencies: update `golang.org/x/sync` to version `v0.22.0` ([#1907](...))
* dependencies: update `golang.org/x/sys` to version `v0.47.0` ([#1907](...))
* dependencies: update `golang.org/x/text` to version `v0.40.0` ([#1907](...))
* dependencies: update `golang.org/x/tools` to version `v0.49.0` ([#1961](...))

BUG FIXES:

* Data Source: `azuread_user` - fix mail lookup error messages so they report the actual mail value instead of an empty string ([#1926](...))
* `azuread_service_principal_token_signing_certificate` - fix delete operation removing the wrong resource ([#1905](...))
