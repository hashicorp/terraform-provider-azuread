...
const testCertificate string = `-----BEGIN CERTIFICATE-----
...
func TestAccAzureADApplicationCertificate_basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccADObjectCertificateApplication_basic(applicationId, keyType, endDate, value),
...
func TestAccAzureADApplicationCertificate_complete(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccADApplicationCertificate_complete(applicationId, keyId, keyType, endDate, value),
				Check: resource.ComposeTestCheckFunc(
					testCheckADApplicationKeyExists(resourceName),
				),
			},
...
func TestAccAzureADApplicationCertificate_relativeEndDate(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccADApplicationCertificate_relativeEndDate(applicationId, keyType, value),
				Check: resource.ComposeTestCheckFunc(
...
func TestAccAzureADApplicationCertificate_requiresImport(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config:      testAccADApplicationCertificate_requiresImport(applicationId, keyType, endDate, value),
...
func testAccADObjectCertificateApplication_basic(applicationId, keyType, endDate, value string) string {
	return fmt.Sprintf(`
%s
...
`, testAccADApplicationCertificate_template(applicationId), keyType, endDate, value)
}

func testAccADApplicationCertificate_complete(applicationId, keyId, keyType, endDate, value string) string {
	return fmt.Sprintf(`
%s
...
`, testAccADApplicationCertificate_template(applicationId), keyId, keyType, endDate, value)
}

func testAccADApplicationCertificate_relativeEndDate(applicationId, keyType, value string) string {
	return fmt.Sprintf(`
%s
...
`, testAccADApplicationCertificate_template(applicationId), keyType, value)
}

func testAccADApplicationCertificate_requiresImport(applicationId, keyType, endDate, value string) string {
	template := testAccADObjectCertificateApplication_basic(applicationId, keyType, endDate, value)
	return fmt.Sprintf(`
%s
