...
func getPolicyId(ctx context.Context, meta interface{}, metadata sdk.ResourceMetaData, scopeId, roleDefinitionId string) (*parse.RoleManagementPolicyId, error) {
	var policyId *parse.RoleManagementPolicyId
	err := consistency.WaitForUpdate(ctx, meta, func(ctx context.Context) (*bool, error) {
