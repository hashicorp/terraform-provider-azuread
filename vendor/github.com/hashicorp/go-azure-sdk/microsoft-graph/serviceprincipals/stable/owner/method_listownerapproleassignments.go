...
func (c OwnerClient) ListOwnerAppRoleAssignments(ctx context.Context, id stable.ServicePrincipalId, options ListOwnerAppRoleAssignmentsOperationOptions) (result ListOwnerAppRoleAssignmentsOperationResponse, err error) {
...
func (c OwnerClient) ListOwnerAppRoleAssignmentsComplete(ctx context.Context, id stable.ServicePrincipalId, options ListOwnerAppRoleAssignmentsOperationOptions) (ListOwnerAppRoleAssignmentsCompleteResult, error) {
...
func (c OwnerClient) ListOwnerAppRoleAssignmentsCompleteMatchingPredicate(ctx context.Context, id stable.ServicePrincipalId, options ListOwnerAppRoleAssignmentsOperationOptions, predicate AppRoleAssignmentOperationPredicate) (result ListOwnerAppRoleAssignmentsCompleteResult, err error) {
