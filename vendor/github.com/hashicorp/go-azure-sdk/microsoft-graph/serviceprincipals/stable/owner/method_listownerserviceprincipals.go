...
func (c OwnerClient) ListOwnerServicePrincipals(ctx context.Context, id stable.ServicePrincipalId, options ListOwnerServicePrincipalsOperationOptions) (result ListOwnerServicePrincipalsOperationResponse, err error) {
...
func (c OwnerClient) ListOwnerServicePrincipalsComplete(ctx context.Context, id stable.ServicePrincipalId, options ListOwnerServicePrincipalsOperationOptions) (ListOwnerServicePrincipalsCompleteResult, error) {
...
func (c OwnerClient) ListOwnerServicePrincipalsCompleteMatchingPredicate(ctx context.Context, id stable.ServicePrincipalId, options ListOwnerServicePrincipalsOperationOptions, predicate ServicePrincipalOperationPredicate) (result ListOwnerServicePrincipalsCompleteResult, err error) {
