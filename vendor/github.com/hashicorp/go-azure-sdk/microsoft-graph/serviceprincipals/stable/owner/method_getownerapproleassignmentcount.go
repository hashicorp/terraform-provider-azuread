...
func (c OwnerClient) GetOwnerAppRoleAssignmentCount(ctx context.Context, id stable.ServicePrincipalId, options GetOwnerAppRoleAssignmentCountOperationOptions) (result GetOwnerAppRoleAssignmentCountOperationResponse, err error) {
