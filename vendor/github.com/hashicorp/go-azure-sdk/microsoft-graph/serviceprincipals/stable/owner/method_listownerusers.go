...
func (c OwnerClient) ListOwnerUsers(ctx context.Context, id stable.ServicePrincipalId, options ListOwnerUsersOperationOptions) (result ListOwnerUsersOperationResponse, err error) {
...
func (c OwnerClient) ListOwnerUsersComplete(ctx context.Context, id stable.ServicePrincipalId, options ListOwnerUsersOperationOptions) (ListOwnerUsersCompleteResult, error) {
...
func (c OwnerClient) ListOwnerUsersCompleteMatchingPredicate(ctx context.Context, id stable.ServicePrincipalId, options ListOwnerUsersOperationOptions, predicate UserOperationPredicate) (result ListOwnerUsersCompleteResult, err error) {
