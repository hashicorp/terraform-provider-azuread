...
func (c OwnerClient) GetOwnerServicePrincipalCount(ctx context.Context, id stable.ServicePrincipalId, options GetOwnerServicePrincipalCountOperationOptions) (result GetOwnerServicePrincipalCountOperationResponse, err error) {
