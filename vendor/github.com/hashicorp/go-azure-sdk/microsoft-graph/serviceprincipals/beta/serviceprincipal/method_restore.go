...
func (c ServicePrincipalClient) Restore(ctx context.Context, id beta.ServicePrincipalId, options RestoreOperationOptions) (result RestoreOperationResponse, err error) {
