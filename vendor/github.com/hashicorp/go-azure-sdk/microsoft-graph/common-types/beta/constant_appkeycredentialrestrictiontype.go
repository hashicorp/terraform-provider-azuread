...
const (
	...
	AppKeyCredentialRestrictionType_TrustedCertificateAuthority AppKeyCredentialRestrictionType = "trustedCertificateAuthority"
)

func PossibleValuesForAppKeyCredentialRestrictionType() []string {
	return []string{
		string(AppKeyCredentialRestrictionType_AsymmetricKeyLifetime),
		string(AppKeyCredentialRestrictionType_TrustedCertificateAuthority),
	}
}
...
func parseAppKeyCredentialRestrictionType(input string) (*AppKeyCredentialRestrictionType, error) {
	vals := map[string]AppKeyCredentialRestrictionType{
		...
		"trustedcertificateauthority": AppKeyCredentialRestrictionType_TrustedCertificateAuthority,
	}
