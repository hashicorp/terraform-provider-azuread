...
var _ HealthMonitoringDirectoryObjectImpactSummary = HealthMonitoringApplicationImpactSummary{}

type HealthMonitoringApplicationImpactSummary struct {
...
func (s HealthMonitoringApplicationImpactSummary) HealthMonitoringDirectoryObjectImpactSummary() BaseHealthMonitoringDirectoryObjectImpactSummaryImpl {
...
func (s HealthMonitoringApplicationImpactSummary) HealthMonitoringResourceImpactSummary() BaseHealthMonitoringResourceImpactSummaryImpl {
...
var _ json.Marshaler = HealthMonitoringApplicationImpactSummary{}

func (s HealthMonitoringApplicationImpactSummary) MarshalJSON() ([]byte, error) {
	type wrapper HealthMonitoringApplicationImpactSummary
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling HealthMonitoringApplicationImpactSummary: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling HealthMonitoringApplicationImpactSummary: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.healthMonitoring.applicationImpactSummary"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling HealthMonitoringApplicationImpactSummary: %+v", err)
	}

	return encoded, nil
}

var _ json.Unmarshaler = &HealthMonitoringApplicationImpactSummary{}

func (s *HealthMonitoringApplicationImpactSummary) UnmarshalJSON(bytes []byte) error {
	var decoded struct {
		ResourceSampling_ODataBind *[]string `json:"resourceSampling@odata.bind,omitempty"`
		ImpactedCount              *string   `json:"impactedCount,omitempty"`
		ImpactedCountLimitExceeded *bool     `json:"impactedCountLimitExceeded,omitempty"`
	...
	if err := json.Unmarshal(bytes, &temp); err != nil {
		return fmt.Errorf("unmarshaling HealthMonitoringApplicationImpactSummary into map[string]json.RawMessage: %+v", err)
	}
	...
	if v, ok := temp["resourceSampling"]; ok {
		...
		for i, val := range listTemp {
			...
			if err != nil {
				return fmt.Errorf("unmarshaling index %d field 'ResourceSampling' for 'HealthMonitoringApplicationImpactSummary': %+v", i, err)
			}
