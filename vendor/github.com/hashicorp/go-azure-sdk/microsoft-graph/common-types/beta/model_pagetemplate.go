...
var _ BaseSitePage = PageTemplate{}
...
func (s PageTemplate) BaseSitePage() BaseBaseSitePageImpl {
...
func (s PageTemplate) BaseItem() BaseBaseItemImpl {
...
func (s PageTemplate) Entity() BaseEntityImpl {
...
var _ json.Marshaler = PageTemplate{}

func (s PageTemplate) MarshalJSON() ([]byte, error) {
	type wrapper PageTemplate
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling PageTemplate: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling PageTemplate: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.pageTemplate"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling PageTemplate: %+v", err)
	}

	return encoded, nil
}

var _ json.Unmarshaler = &PageTemplate{}

func (s *PageTemplate) UnmarshalJSON(bytes []byte) error {
	var decoded struct {
		CanvasLayout         *CanvasLayout         `json:"canvasLayout,omitempty"`
		TitleArea            *TitleArea            `json:"titleArea,omitempty"`
		PageLayout           *PageLayoutType       `json:"pageLayout,omitempty"`
	...
	if err := json.Unmarshal(bytes, &temp); err != nil {
		return fmt.Errorf("unmarshaling PageTemplate into map[string]json.RawMessage: %+v", err)
	}

	if v, ok := temp["createdBy"]; ok {
		impl, err := UnmarshalIdentitySetImplementation(v)
		if err != nil {
			return fmt.Errorf("unmarshaling field 'CreatedBy' for 'PageTemplate': %+v", err)
		}
		s.CreatedBy = &impl
	}
	...
	if v, ok := temp["lastModifiedBy"]; ok {
		impl, err := UnmarshalIdentitySetImplementation(v)
		if err != nil {
			return fmt.Errorf("unmarshaling field 'LastModifiedBy' for 'PageTemplate': %+v", err)
		}
	...
	if v, ok := temp["webParts"]; ok {
		...
		for i, val := range listTemp {
			...
			if err != nil {
				return fmt.Errorf("unmarshaling index %d field 'WebParts' for 'PageTemplate': %+v", i, err)
			}
