...
const (
	...
	MeetingMessageType_MeetingTentativelyAccepted MeetingMessageType = "meetingTentativelyAccepted"
...
func PossibleValuesForMeetingMessageType() []string {
	return []string{
		...
		string(MeetingMessageType_MeetingTentativelyAccepted),
...
func parseMeetingMessageType(input string) (*MeetingMessageType, error) {
	vals := map[string]MeetingMessageType{
		...
		"meetingtentativelyaccepted": MeetingMessageType_MeetingTentativelyAccepted,
