...
const (
	...
	DevicePlatformType_WindowsMobileApplicationManagement DevicePlatformType = "windowsMobileApplicationManagement"
...
func PossibleValuesForDevicePlatformType() []string {
	return []string{
		...
		string(DevicePlatformType_WindowsMobileApplicationManagement),
...
func parseDevicePlatformType(input string) (*DevicePlatformType, error) {
	vals := map[string]DevicePlatformType{
		...
		"windowsmobileapplicationmanagement": DevicePlatformType_WindowsMobileApplicationManagement,
