...
const (
	...
	SimulationAttackTechnique_OAuthConsentGrant    SimulationAttackTechnique = "oAuthConsentGrant"
	SimulationAttackTechnique_PhishTraining        SimulationAttackTechnique = "phishTraining"
...
func PossibleValuesForSimulationAttackTechnique() []string {
	return []string{
		...
		string(SimulationAttackTechnique_OAuthConsentGrant),
		string(SimulationAttackTechnique_PhishTraining),
...
func parseSimulationAttackTechnique(input string) (*SimulationAttackTechnique, error) {
	vals := map[string]SimulationAttackTechnique{
		...
		"oauthconsentgrant":    SimulationAttackTechnique_OAuthConsentGrant,
		"phishtraining":        SimulationAttackTechnique_PhishTraining,
