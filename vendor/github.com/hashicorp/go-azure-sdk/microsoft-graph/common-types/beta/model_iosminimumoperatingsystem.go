...
type IosMinimumOperatingSystem struct {
	...
	// When TRUE, only Version 16.0 or later is supported. Default value is FALSE. Exactly one of the minimum operating
	// system boolean values will be TRUE.
	V160 *bool `json:"v16_0,omitempty"`

	// When TRUE, only Version 17.0 or later is supported. Default value is FALSE. Exactly one of the minimum operating
	// system boolean values will be TRUE.
