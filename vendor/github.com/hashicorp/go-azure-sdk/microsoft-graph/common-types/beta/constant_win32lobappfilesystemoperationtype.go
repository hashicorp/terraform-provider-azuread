...
const (
	Win32LobAppFileSystemOperationType_AppVersion    Win32LobAppFileSystemOperationType = "appVersion"
	Win32LobAppFileSystemOperationType_CreatedDate   Win32LobAppFileSystemOperationType = "createdDate"
	Win32LobAppFileSystemOperationType_DoesNotExist  Win32LobAppFileSystemOperationType = "doesNotExist"
	...
	Win32LobAppFileSystemOperationType_SizeInBytes   Win32LobAppFileSystemOperationType = "sizeInBytes"
...
func PossibleValuesForWin32LobAppFileSystemOperationType() []string {
	return []string{
		string(Win32LobAppFileSystemOperationType_AppVersion),
		string(Win32LobAppFileSystemOperationType_CreatedDate),
		string(Win32LobAppFileSystemOperationType_DoesNotExist),
		...
		string(Win32LobAppFileSystemOperationType_SizeInBytes),
...
func parseWin32LobAppFileSystemOperationType(input string) (*Win32LobAppFileSystemOperationType, error) {
	vals := map[string]Win32LobAppFileSystemOperationType{
		"appversion":    Win32LobAppFileSystemOperationType_AppVersion,
		"createddate":   Win32LobAppFileSystemOperationType_CreatedDate,
		"doesnotexist":  Win32LobAppFileSystemOperationType_DoesNotExist,
		...
		"sizeinbytes":   Win32LobAppFileSystemOperationType_SizeInBytes,
