...
var _ HealthMonitoringDirectoryObjectImpactSummary = HealthMonitoringDeviceImpactSummary{}

type HealthMonitoringDeviceImpactSummary struct {
...
func (s HealthMonitoringDeviceImpactSummary) HealthMonitoringDirectoryObjectImpactSummary() BaseHealthMonitoringDirectoryObjectImpactSummaryImpl {
...
func (s HealthMonitoringDeviceImpactSummary) HealthMonitoringResourceImpactSummary() BaseHealthMonitoringResourceImpactSummaryImpl {
...
var _ json.Marshaler = HealthMonitoringDeviceImpactSummary{}

func (s HealthMonitoringDeviceImpactSummary) MarshalJSON() ([]byte, error) {
	type wrapper HealthMonitoringDeviceImpactSummary
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling HealthMonitoringDeviceImpactSummary: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling HealthMonitoringDeviceImpactSummary: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.healthMonitoring.deviceImpactSummary"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling HealthMonitoringDeviceImpactSummary: %+v", err)
	}

	return encoded, nil
}

var _ json.Unmarshaler = &HealthMonitoringDeviceImpactSummary{}

func (s *HealthMonitoringDeviceImpactSummary) UnmarshalJSON(bytes []byte) error {
	var decoded struct {
		ResourceSampling_ODataBind *[]string `json:"resourceSampling@odata.bind,omitempty"`
		ImpactedCount              *string   `json:"impactedCount,omitempty"`
		ImpactedCountLimitExceeded *bool     `json:"impactedCountLimitExceeded,omitempty"`
	...
	if err := json.Unmarshal(bytes, &temp); err != nil {
		return fmt.Errorf("unmarshaling HealthMonitoringDeviceImpactSummary into map[string]json.RawMessage: %+v", err)
	}
	...
	if v, ok := temp["resourceSampling"]; ok {
		...
		for i, val := range listTemp {
			...
			if err != nil {
				return fmt.Errorf("unmarshaling index %d field 'ResourceSampling' for 'HealthMonitoringDeviceImpactSummary': %+v", i, err)
			}
