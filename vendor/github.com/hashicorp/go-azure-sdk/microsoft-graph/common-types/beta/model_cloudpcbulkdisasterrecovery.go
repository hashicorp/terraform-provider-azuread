...
var _ CloudPCBulkAction = CloudPCBulkDisasterRecovery{}
...
func (s CloudPCBulkDisasterRecovery) CloudPCBulkAction() BaseCloudPCBulkActionImpl {
...
func (s CloudPCBulkDisasterRecovery) Entity() BaseEntityImpl {
...
var _ json.Marshaler = CloudPCBulkDisasterRecovery{}

func (s CloudPCBulkDisasterRecovery) MarshalJSON() ([]byte, error) {
	type wrapper CloudPCBulkDisasterRecovery
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling CloudPCBulkDisasterRecovery: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling CloudPCBulkDisasterRecovery: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.cloudPcBulkDisasterRecovery"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling CloudPCBulkDisasterRecovery: %+v", err)
	}
