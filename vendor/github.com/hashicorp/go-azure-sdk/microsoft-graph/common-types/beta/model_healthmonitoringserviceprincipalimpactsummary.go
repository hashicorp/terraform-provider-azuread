...
var _ HealthMonitoringDirectoryObjectImpactSummary = HealthMonitoringServicePrincipalImpactSummary{}

type HealthMonitoringServicePrincipalImpactSummary struct {
...
func (s HealthMonitoringServicePrincipalImpactSummary) HealthMonitoringDirectoryObjectImpactSummary() BaseHealthMonitoringDirectoryObjectImpactSummaryImpl {
...
func (s HealthMonitoringServicePrincipalImpactSummary) HealthMonitoringResourceImpactSummary() BaseHealthMonitoringResourceImpactSummaryImpl {
...
var _ json.Marshaler = HealthMonitoringServicePrincipalImpactSummary{}

func (s HealthMonitoringServicePrincipalImpactSummary) MarshalJSON() ([]byte, error) {
	type wrapper HealthMonitoringServicePrincipalImpactSummary
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling HealthMonitoringServicePrincipalImpactSummary: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling HealthMonitoringServicePrincipalImpactSummary: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.healthMonitoring.servicePrincipalImpactSummary"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling HealthMonitoringServicePrincipalImpactSummary: %+v", err)
	}

	return encoded, nil
}

var _ json.Unmarshaler = &HealthMonitoringServicePrincipalImpactSummary{}

func (s *HealthMonitoringServicePrincipalImpactSummary) UnmarshalJSON(bytes []byte) error {
	var decoded struct {
		ResourceSampling_ODataBind *[]string `json:"resourceSampling@odata.bind,omitempty"`
		ImpactedCount              *string   `json:"impactedCount,omitempty"`
		ImpactedCountLimitExceeded *bool     `json:"impactedCountLimitExceeded,omitempty"`
	...
	if err := json.Unmarshal(bytes, &temp); err != nil {
		return fmt.Errorf("unmarshaling HealthMonitoringServicePrincipalImpactSummary into map[string]json.RawMessage: %+v", err)
	}
	...
	if v, ok := temp["resourceSampling"]; ok {
		...
		for i, val := range listTemp {
			...
			if err != nil {
				return fmt.Errorf("unmarshaling index %d field 'ResourceSampling' for 'HealthMonitoringServicePrincipalImpactSummary': %+v", i, err)
			}
