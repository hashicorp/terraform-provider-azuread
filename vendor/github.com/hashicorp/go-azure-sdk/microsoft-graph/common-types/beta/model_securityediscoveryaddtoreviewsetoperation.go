...
type SecurityEdiscoveryAddToReviewSetOperation struct {
	// The options to add items to the review set. Possible values are: allVersions, linkedFiles, unknownFutureValue,
	// advancedIndexing, listAttachments, htmlTranscripts, messageConversationExpansion, locationsWithoutHits,
	// allItemsInFolder. Use the Prefer: include-unknown-enum-members request header to get the following values from this
	// evolvable enum: advancedIndexing, listAttachments, htmlTranscripts, messageConversationExpansion,
	// locationsWithoutHits, allItemsInFolder.
	AdditionalDataOptions *SecurityAdditionalDataOptions `json:"additionalDataOptions,omitempty"`

	// Specifies the number of most recent versions of cloud attachments to collect. Possible values are: latest, recent10,
	// recent100, all, unknownFutureValue.
	CloudAttachmentVersion *SecurityCloudAttachmentVersion `json:"cloudAttachmentVersion,omitempty"`

	// Specifies the number of most recent versions of SharePoint documents to collect. Possible values are: latest,
	// recent10, recent100, all, unknownFutureValue.
