...
const (
	...
	VppTokenState_DuplicateLocationId   VppTokenState = "duplicateLocationId"
...
func PossibleValuesForVppTokenState() []string {
	return []string{
		...
		string(VppTokenState_DuplicateLocationId),
...
func parseVppTokenState(input string) (*VppTokenState, error) {
	vals := map[string]VppTokenState{
		...
		"duplicatelocationid":   VppTokenState_DuplicateLocationId,
