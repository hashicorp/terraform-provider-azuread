...
const (
	...
	SecurityAdditionalOptions_OptimizedPartitionSize      SecurityAdditionalOptions = "optimizedPartitionSize"
...
func PossibleValuesForSecurityAdditionalOptions() []string {
	return []string{
		...
		string(SecurityAdditionalOptions_OptimizedPartitionSize),
...
func parseSecurityAdditionalOptions(input string) (*SecurityAdditionalOptions, error) {
	vals := map[string]SecurityAdditionalOptions{
		...
		"optimizedpartitionsize":      SecurityAdditionalOptions_OptimizedPartitionSize,
