...
const (
	...
	AutomaticUpdateMode_WindowsDefault                            AutomaticUpdateMode = "windowsDefault"
)
...
func PossibleValuesForAutomaticUpdateMode() []string {
	return []string{
		...
		string(AutomaticUpdateMode_WindowsDefault),
	}
}
...
func parseAutomaticUpdateMode(input string) (*AutomaticUpdateMode, error) {
	vals := map[string]AutomaticUpdateMode{
		...
		"windowsdefault":                            AutomaticUpdateMode_WindowsDefault,
	}
