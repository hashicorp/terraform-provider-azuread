...
var _ HealthMonitoringDirectoryObjectImpactSummary = HealthMonitoringUserImpactSummary{}

type HealthMonitoringUserImpactSummary struct {
...
func (s HealthMonitoringUserImpactSummary) HealthMonitoringDirectoryObjectImpactSummary() BaseHealthMonitoringDirectoryObjectImpactSummaryImpl {
...
func (s HealthMonitoringUserImpactSummary) HealthMonitoringResourceImpactSummary() BaseHealthMonitoringResourceImpactSummaryImpl {
...
var _ json.Marshaler = HealthMonitoringUserImpactSummary{}

func (s HealthMonitoringUserImpactSummary) MarshalJSON() ([]byte, error) {
	type wrapper HealthMonitoringUserImpactSummary
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling HealthMonitoringUserImpactSummary: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling HealthMonitoringUserImpactSummary: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.healthMonitoring.userImpactSummary"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling HealthMonitoringUserImpactSummary: %+v", err)
	}

	return encoded, nil
}

var _ json.Unmarshaler = &HealthMonitoringUserImpactSummary{}

func (s *HealthMonitoringUserImpactSummary) UnmarshalJSON(bytes []byte) error {
	var decoded struct {
		ResourceSampling_ODataBind *[]string `json:"resourceSampling@odata.bind,omitempty"`
		ImpactedCount              *string   `json:"impactedCount,omitempty"`
		ImpactedCountLimitExceeded *bool     `json:"impactedCountLimitExceeded,omitempty"`
	...
	if err := json.Unmarshal(bytes, &temp); err != nil {
		return fmt.Errorf("unmarshaling HealthMonitoringUserImpactSummary into map[string]json.RawMessage: %+v", err)
	}
	...
	if v, ok := temp["resourceSampling"]; ok {
		...
		for i, val := range listTemp {
			...
			if err != nil {
				return fmt.Errorf("unmarshaling index %d field 'ResourceSampling' for 'HealthMonitoringUserImpactSummary': %+v", i, err)
			}
