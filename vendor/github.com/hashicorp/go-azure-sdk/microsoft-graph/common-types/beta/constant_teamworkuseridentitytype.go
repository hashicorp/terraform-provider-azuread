...
const (
	...
	TeamworkUserIdentityType_AzureCommunicationServicesUser TeamworkUserIdentityType = "azureCommunicationServicesUser"
...
func PossibleValuesForTeamworkUserIdentityType() []string {
	return []string{
		...
		string(TeamworkUserIdentityType_AzureCommunicationServicesUser),
...
func parseTeamworkUserIdentityType(input string) (*TeamworkUserIdentityType, error) {
	vals := map[string]TeamworkUserIdentityType{
		...
		"azurecommunicationservicesuser": TeamworkUserIdentityType_AzureCommunicationServicesUser,
