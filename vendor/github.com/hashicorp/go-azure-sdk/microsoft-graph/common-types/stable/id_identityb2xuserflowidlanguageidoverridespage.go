...
// IdentityB2xUserFlowIdLanguageIdOverridesPageId is a struct representing the Resource ID for a Identity B 2 x User Flow Id Language Id Overrides Page
...
// ValidateIdentityB2xUserFlowIdLanguageIdOverridesPageID checks that 'input' can be parsed as a Identity B 2 x User Flow Id Language Id Overrides Page ID
...
// ID returns the formatted Identity B 2 x User Flow Id Language Id Overrides Page ID
...
// Segments returns a slice of Resource ID Segments which comprise this Identity B 2 x User Flow Id Language Id Overrides Page ID
...
// String returns a human-readable description of this Identity B 2 x User Flow Id Language Id Overrides Page ID
