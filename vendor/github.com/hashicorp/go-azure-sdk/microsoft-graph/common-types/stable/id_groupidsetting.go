...
func NewGroupIdSettingID(groupId string, groupSettingId string) GroupIdSettingId {
...
func (id *GroupIdSettingId) FromParseResult(input resourceids.ParseResult) error {
	...
	if id.GroupSettingId, ok = input.Parsed["groupSettingId"]; !ok {
		return resourceids.NewSegmentNotSpecifiedError(id, "groupSettingId", input)
	}
...
func (id GroupIdSettingId) Segments() []resourceids.Segment {
	return []resourceids.Segment{
		...
		resourceids.UserSpecifiedSegment("groupSettingId", "groupSettingId"),
	}
}
