...
type BaseAuthenticationCombinationConfigurationImpl struct {
	// Which authentication method combinations this configuration applies to. Must be an allowedCombinations object, part
	// of the authenticationStrengthPolicy. The only possible value for fido2combinationConfigurations is 'fido2'.
...
func (s RawAuthenticationCombinationConfigurationImpl) MarshalJSON() ([]byte, error) {
