...
var _ RestoreArtifactsBulkRequestBase = DriveRestoreArtifactsBulkAdditionRequest{}

type DriveRestoreArtifactsBulkAdditionRequest struct {
	// The list of directory object IDs that are added to the corresponding OneDrive for work or school restore session in a
	// bulk operation.
	DirectoryObjectIds *[]string `json:"directoryObjectIds,omitempty"`

	// The list of email addresses that are added to the corresponding OneDrive for work or school restore session in a bulk
	// operation.
...
func (s DriveRestoreArtifactsBulkAdditionRequest) RestoreArtifactsBulkRequestBase() BaseRestoreArtifactsBulkRequestBaseImpl {
...
func (s DriveRestoreArtifactsBulkAdditionRequest) Entity() BaseEntityImpl {
...
var _ json.Marshaler = DriveRestoreArtifactsBulkAdditionRequest{}

func (s DriveRestoreArtifactsBulkAdditionRequest) MarshalJSON() ([]byte, error) {
	type wrapper DriveRestoreArtifactsBulkAdditionRequest
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling DriveRestoreArtifactsBulkAdditionRequest: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling DriveRestoreArtifactsBulkAdditionRequest: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.driveRestoreArtifactsBulkAdditionRequest"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling DriveRestoreArtifactsBulkAdditionRequest: %+v", err)
	}

	return encoded, nil
}

var _ json.Unmarshaler = &DriveRestoreArtifactsBulkAdditionRequest{}

func (s *DriveRestoreArtifactsBulkAdditionRequest) UnmarshalJSON(bytes []byte) error {
	var decoded struct {
		DirectoryObjectIds     *[]string                          `json:"directoryObjectIds,omitempty"`
		Drives                 *[]string                          `json:"drives,omitempty"`
		CreatedDateTime        nullable.Type[string]              `json:"createdDateTime,omitempty"`
	...
	if err := json.Unmarshal(bytes, &temp); err != nil {
		return fmt.Errorf("unmarshaling DriveRestoreArtifactsBulkAdditionRequest into map[string]json.RawMessage: %+v", err)
	}

	if v, ok := temp["createdBy"]; ok {
		impl, err := UnmarshalIdentitySetImplementation(v)
		if err != nil {
			return fmt.Errorf("unmarshaling field 'CreatedBy' for 'DriveRestoreArtifactsBulkAdditionRequest': %+v", err)
		}
		s.CreatedBy = impl
	}
	...
	if v, ok := temp["lastModifiedBy"]; ok {
		impl, err := UnmarshalIdentitySetImplementation(v)
		if err != nil {
			return fmt.Errorf("unmarshaling field 'LastModifiedBy' for 'DriveRestoreArtifactsBulkAdditionRequest': %+v", err)
		}
