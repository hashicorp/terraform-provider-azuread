...
var _ RestoreArtifactsBulkRequestBase = MailboxRestoreArtifactsBulkAdditionRequest{}
...
func (s MailboxRestoreArtifactsBulkAdditionRequest) RestoreArtifactsBulkRequestBase() BaseRestoreArtifactsBulkRequestBaseImpl {
...
func (s MailboxRestoreArtifactsBulkAdditionRequest) Entity() BaseEntityImpl {
...
var _ json.Marshaler = MailboxRestoreArtifactsBulkAdditionRequest{}

func (s MailboxRestoreArtifactsBulkAdditionRequest) MarshalJSON() ([]byte, error) {
	type wrapper MailboxRestoreArtifactsBulkAdditionRequest
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling MailboxRestoreArtifactsBulkAdditionRequest: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling MailboxRestoreArtifactsBulkAdditionRequest: %+v", err)
	}

	if !s.OmitDiscriminatedValue {
		decoded["@odata.type"] = "#microsoft.graph.mailboxRestoreArtifactsBulkAdditionRequest"
	}

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling MailboxRestoreArtifactsBulkAdditionRequest: %+v", err)
	}

	return encoded, nil
}

var _ json.Unmarshaler = &MailboxRestoreArtifactsBulkAdditionRequest{}

func (s *MailboxRestoreArtifactsBulkAdditionRequest) UnmarshalJSON(bytes []byte) error {
	var decoded struct {
		DirectoryObjectIds     *[]string                          `json:"directoryObjectIds,omitempty"`
		Mailboxes              *[]string                          `json:"mailboxes,omitempty"`
		CreatedDateTime        nullable.Type[string]              `json:"createdDateTime,omitempty"`
	...
	if err := json.Unmarshal(bytes, &temp); err != nil {
		return fmt.Errorf("unmarshaling MailboxRestoreArtifactsBulkAdditionRequest into map[string]json.RawMessage: %+v", err)
	}

	if v, ok := temp["createdBy"]; ok {
		impl, err := UnmarshalIdentitySetImplementation(v)
		if err != nil {
			return fmt.Errorf("unmarshaling field 'CreatedBy' for 'MailboxRestoreArtifactsBulkAdditionRequest': %+v", err)
		}
		s.CreatedBy = impl
	}
	...
	if v, ok := temp["lastModifiedBy"]; ok {
		impl, err := UnmarshalIdentitySetImplementation(v)
		if err != nil {
			return fmt.Errorf("unmarshaling field 'LastModifiedBy' for 'MailboxRestoreArtifactsBulkAdditionRequest': %+v", err)
		}
