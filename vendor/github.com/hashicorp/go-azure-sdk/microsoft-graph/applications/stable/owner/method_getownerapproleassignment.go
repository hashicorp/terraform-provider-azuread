...
func (c OwnerClient) GetOwnerAppRoleAssignment(ctx context.Context, id stable.ApplicationIdOwnerId, options GetOwnerAppRoleAssignmentOperationOptions) (result GetOwnerAppRoleAssignmentOperationResponse, err error) {
