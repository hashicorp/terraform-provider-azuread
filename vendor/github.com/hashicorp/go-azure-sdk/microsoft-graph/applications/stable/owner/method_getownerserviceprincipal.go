...
func (c OwnerClient) GetOwnerServicePrincipal(ctx context.Context, id stable.ApplicationIdOwnerId, options GetOwnerServicePrincipalOperationOptions) (result GetOwnerServicePrincipalOperationResponse, err error) {
