...
func (c AdministrativeUnitMemberClient) GetAdministrativeUnitMemberOrgContactCount(ctx context.Context, id beta.DirectoryAdministrativeUnitId, options GetAdministrativeUnitMemberOrgContactCountOperationOptions) (result GetAdministrativeUnitMemberOrgContactCountOperationResponse, err error) {
