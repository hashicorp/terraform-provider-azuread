...
func (c AdministrativeUnitMemberClient) ListAdministrativeUnitMemberGroups(ctx context.Context, id beta.DirectoryAdministrativeUnitId, options ListAdministrativeUnitMemberGroupsOperationOptions) (result ListAdministrativeUnitMemberGroupsOperationResponse, err error) {
...
func (c AdministrativeUnitMemberClient) ListAdministrativeUnitMemberGroupsComplete(ctx context.Context, id beta.DirectoryAdministrativeUnitId, options ListAdministrativeUnitMemberGroupsOperationOptions) (ListAdministrativeUnitMemberGroupsCompleteResult, error) {
