...
func (c AdministrativeUnitMemberClient) GetAdministrativeUnitMemberGroupCount(ctx context.Context, id beta.DirectoryAdministrativeUnitId, options GetAdministrativeUnitMemberGroupCountOperationOptions) (result GetAdministrativeUnitMemberGroupCountOperationResponse, err error) {
