...
// collection
func (c AdministrativeUnitMemberClient) ListAdministrativeUnitMemberUsers(ctx context.Context, id beta.DirectoryAdministrativeUnitId, options ListAdministrativeUnitMemberUsersOperationOptions) (result ListAdministrativeUnitMemberUsersOperationResponse, err error) {
...
func (c AdministrativeUnitMemberClient) ListAdministrativeUnitMemberUsersComplete(ctx context.Context, id beta.DirectoryAdministrativeUnitId, options ListAdministrativeUnitMemberUsersOperationOptions) (ListAdministrativeUnitMemberUsersCompleteResult, error) {
...
func (c AdministrativeUnitMemberClient) ListAdministrativeUnitMemberUsersCompleteMatchingPredicate(ctx context.Context, id beta.DirectoryAdministrativeUnitId, options ListAdministrativeUnitMemberUsersOperationOptions, predicate UserOperationPredicate) (result ListAdministrativeUnitMemberUsersCompleteResult, err error) {
