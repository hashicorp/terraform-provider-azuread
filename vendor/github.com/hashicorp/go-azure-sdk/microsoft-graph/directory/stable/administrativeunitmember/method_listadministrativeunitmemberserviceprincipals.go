...
func (c AdministrativeUnitMemberClient) ListAdministrativeUnitMemberServicePrincipals(ctx context.Context, id stable.DirectoryAdministrativeUnitId, options ListAdministrativeUnitMemberServicePrincipalsOperationOptions) (result ListAdministrativeUnitMemberServicePrincipalsOperationResponse, err error) {
...
func (c AdministrativeUnitMemberClient) ListAdministrativeUnitMemberServicePrincipalsComplete(ctx context.Context, id stable.DirectoryAdministrativeUnitId, options ListAdministrativeUnitMemberServicePrincipalsOperationOptions) (ListAdministrativeUnitMemberServicePrincipalsCompleteResult, error) {
...
func (c AdministrativeUnitMemberClient) ListAdministrativeUnitMemberServicePrincipalsCompleteMatchingPredicate(ctx context.Context, id stable.DirectoryAdministrativeUnitId, options ListAdministrativeUnitMemberServicePrincipalsOperationOptions, predicate ServicePrincipalOperationPredicate) (result ListAdministrativeUnitMemberServicePrincipalsCompleteResult, err error) {
