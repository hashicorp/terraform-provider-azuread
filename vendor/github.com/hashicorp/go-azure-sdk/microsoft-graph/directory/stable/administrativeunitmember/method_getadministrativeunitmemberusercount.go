...
func (c AdministrativeUnitMemberClient) GetAdministrativeUnitMemberUserCount(ctx context.Context, id stable.DirectoryAdministrativeUnitId, options GetAdministrativeUnitMemberUserCountOperationOptions) (result GetAdministrativeUnitMemberUserCountOperationResponse, err error) {
