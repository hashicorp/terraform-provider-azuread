...
func (c AdministrativeUnitMemberClient) ListAdministrativeUnitMemberOrgContacts(ctx context.Context, id stable.DirectoryAdministrativeUnitId, options ListAdministrativeUnitMemberOrgContactsOperationOptions) (result ListAdministrativeUnitMemberOrgContactsOperationResponse, err error) {
...
func (c AdministrativeUnitMemberClient) ListAdministrativeUnitMemberOrgContactsComplete(ctx context.Context, id stable.DirectoryAdministrativeUnitId, options ListAdministrativeUnitMemberOrgContactsOperationOptions) (ListAdministrativeUnitMemberOrgContactsCompleteResult, error) {
