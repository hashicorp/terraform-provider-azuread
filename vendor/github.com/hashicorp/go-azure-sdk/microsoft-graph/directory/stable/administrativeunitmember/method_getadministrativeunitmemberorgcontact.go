...
func (c AdministrativeUnitMemberClient) GetAdministrativeUnitMemberOrgContact(ctx context.Context, id stable.DirectoryAdministrativeUnitIdMemberId, options GetAdministrativeUnitMemberOrgContactOperationOptions) (result GetAdministrativeUnitMemberOrgContactOperationResponse, err error) {
