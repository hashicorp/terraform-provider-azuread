...
func (c TransitiveMemberClient) GetTransitiveMemberUserCount(ctx context.Context, id beta.GroupId, options GetTransitiveMemberUserCountOperationOptions) (result GetTransitiveMemberUserCountOperationResponse, err error) {
