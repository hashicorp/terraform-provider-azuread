...
func (c TransitiveMemberClient) GetTransitiveMemberServicePrincipal(ctx context.Context, id beta.GroupIdTransitiveMemberId, options GetTransitiveMemberServicePrincipalOperationOptions) (result GetTransitiveMemberServicePrincipalOperationResponse, err error) {
