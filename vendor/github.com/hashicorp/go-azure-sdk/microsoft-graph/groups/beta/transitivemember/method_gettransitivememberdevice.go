...
func (c TransitiveMemberClient) GetTransitiveMemberDevice(ctx context.Context, id beta.GroupIdTransitiveMemberId, options GetTransitiveMemberDeviceOperationOptions) (result GetTransitiveMemberDeviceOperationResponse, err error) {
