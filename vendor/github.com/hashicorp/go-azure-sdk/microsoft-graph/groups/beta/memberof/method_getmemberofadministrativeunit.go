...
func (c MemberOfClient) GetMemberOfAdministrativeUnit(ctx context.Context, id beta.GroupIdMemberOfId, options GetMemberOfAdministrativeUnitOperationOptions) (result GetMemberOfAdministrativeUnitOperationResponse, err error) {
