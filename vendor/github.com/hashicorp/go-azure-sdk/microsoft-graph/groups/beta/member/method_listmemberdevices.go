...
func (c MemberClient) ListMemberDevices(ctx context.Context, id beta.GroupId, options ListMemberDevicesOperationOptions) (result ListMemberDevicesOperationResponse, err error) {
...
func (c MemberClient) ListMemberDevicesComplete(ctx context.Context, id beta.GroupId, options ListMemberDevicesOperationOptions) (ListMemberDevicesCompleteResult, error) {
...
func (c MemberClient) ListMemberDevicesCompleteMatchingPredicate(ctx context.Context, id beta.GroupId, options ListMemberDevicesOperationOptions, predicate DeviceOperationPredicate) (result ListMemberDevicesCompleteResult, err error) {
