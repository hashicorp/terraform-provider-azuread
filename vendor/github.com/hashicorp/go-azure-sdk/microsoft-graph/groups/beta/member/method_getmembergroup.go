...
func (c MemberClient) GetMemberGroup(ctx context.Context, id beta.GroupIdMemberId, options GetMemberGroupOperationOptions) (result GetMemberGroupOperationResponse, err error) {
