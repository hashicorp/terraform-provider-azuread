...
func (c MemberClient) GetMemberApplication(ctx context.Context, id beta.GroupIdMemberId, options GetMemberApplicationOperationOptions) (result GetMemberApplicationOperationResponse, err error) {
