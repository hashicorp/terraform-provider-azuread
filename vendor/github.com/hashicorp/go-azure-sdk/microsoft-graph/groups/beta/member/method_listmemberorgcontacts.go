...
// collection
func (c MemberClient) ListMemberOrgContacts(ctx context.Context, id beta.GroupId, options ListMemberOrgContactsOperationOptions) (result ListMemberOrgContactsOperationResponse, err error) {
...
func (c MemberClient) ListMemberOrgContactsComplete(ctx context.Context, id beta.GroupId, options ListMemberOrgContactsOperationOptions) (ListMemberOrgContactsCompleteResult, error) {
...
func (c MemberClient) ListMemberOrgContactsCompleteMatchingPredicate(ctx context.Context, id beta.GroupId, options ListMemberOrgContactsOperationOptions, predicate OrgContactOperationPredicate) (result ListMemberOrgContactsCompleteResult, err error) {
