...
// GetMemberUser - List group members. Get a list of the group's direct members. A group can have users, contacts,
// devices, service principals, and other groups as members. This operation isn't transitive.
func (c MemberClient) GetMemberUser(ctx context.Context, id beta.GroupIdMemberId, options GetMemberUserOperationOptions) (result GetMemberUserOperationResponse, err error) {
