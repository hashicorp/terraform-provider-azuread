...
func (c OwnerClient) GetOwnerServicePrincipal(ctx context.Context, id beta.GroupIdOwnerId, options GetOwnerServicePrincipalOperationOptions) (result GetOwnerServicePrincipalOperationResponse, err error) {
