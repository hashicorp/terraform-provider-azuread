...
func (c OwnerClient) GetOwnerServicePrincipalCount(ctx context.Context, id beta.GroupId, options GetOwnerServicePrincipalCountOperationOptions) (result GetOwnerServicePrincipalCountOperationResponse, err error) {
