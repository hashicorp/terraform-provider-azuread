...
func (c OwnerClient) ListOwnerServicePrincipals(ctx context.Context, id beta.GroupId, options ListOwnerServicePrincipalsOperationOptions) (result ListOwnerServicePrincipalsOperationResponse, err error) {
...
func (c OwnerClient) ListOwnerServicePrincipalsComplete(ctx context.Context, id beta.GroupId, options ListOwnerServicePrincipalsOperationOptions) (ListOwnerServicePrincipalsCompleteResult, error) {
...
func (c OwnerClient) ListOwnerServicePrincipalsCompleteMatchingPredicate(ctx context.Context, id beta.GroupId, options ListOwnerServicePrincipalsOperationOptions, predicate ServicePrincipalOperationPredicate) (result ListOwnerServicePrincipalsCompleteResult, err error) {
