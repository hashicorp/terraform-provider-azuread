...
func (c OwnerClient) ListOwnerUsers(ctx context.Context, id beta.GroupId, options ListOwnerUsersOperationOptions) (result ListOwnerUsersOperationResponse, err error) {
...
func (c OwnerClient) ListOwnerUsersComplete(ctx context.Context, id beta.GroupId, options ListOwnerUsersOperationOptions) (ListOwnerUsersCompleteResult, error) {
...
func (c OwnerClient) ListOwnerUsersCompleteMatchingPredicate(ctx context.Context, id beta.GroupId, options ListOwnerUsersOperationOptions, predicate UserOperationPredicate) (result ListOwnerUsersCompleteResult, err error) {
