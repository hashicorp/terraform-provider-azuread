...
func (c MemberClient) GetMemberDevice(ctx context.Context, id stable.DirectoryRoleIdMemberId, options GetMemberDeviceOperationOptions) (result GetMemberDeviceOperationResponse, err error) {
