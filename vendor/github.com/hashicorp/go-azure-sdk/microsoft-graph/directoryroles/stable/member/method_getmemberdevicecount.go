...
func (c MemberClient) GetMemberDeviceCount(ctx context.Context, id stable.DirectoryRoleId, options GetMemberDeviceCountOperationOptions) (result GetMemberDeviceCountOperationResponse, err error) {
