...
// GetMemberServicePrincipal - Get the item of type microsoft.graph.directoryObject as microsoft.graph.servicePrincipal
func (c MemberClient) GetMemberServicePrincipal(ctx context.Context, id stable.DirectoryRoleIdMemberId, options GetMemberServicePrincipalOperationOptions) (result GetMemberServicePrincipalOperationResponse, err error) {
