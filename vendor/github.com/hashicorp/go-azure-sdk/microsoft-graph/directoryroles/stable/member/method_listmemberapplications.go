...
// collection
func (c MemberClient) ListMemberApplications(ctx context.Context, id stable.DirectoryRoleId, options ListMemberApplicationsOperationOptions) (result ListMemberApplicationsOperationResponse, err error) {
...
func (c MemberClient) ListMemberApplicationsComplete(ctx context.Context, id stable.DirectoryRoleId, options ListMemberApplicationsOperationOptions) (ListMemberApplicationsCompleteResult, error) {
...
func (c MemberClient) ListMemberApplicationsCompleteMatchingPredicate(ctx context.Context, id stable.DirectoryRoleId, options ListMemberApplicationsOperationOptions, predicate ApplicationOperationPredicate) (result ListMemberApplicationsCompleteResult, err error) {
